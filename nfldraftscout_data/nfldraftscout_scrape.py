...
def store_data(soup,cur):
    ...
    for url in url_list:
        ...
        print(profile_entry)
        cur.execute("INSERT INTO PLAYERS VALUES('%s')"
          % (url))
